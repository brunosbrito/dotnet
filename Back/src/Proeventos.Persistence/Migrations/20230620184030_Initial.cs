    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RedesSoiciais", x => x.id);
                    table.ForeignKey(
                        name: "FK_RedesSoiciais_Eventos_EventoId",
                        column: x => x.EventoId,
                        principalTable: "Eventos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RedesSoiciais_Palestrantes_PalestranteId",
                        column: x => x.PalestranteId,
                        principalTable: "Palestrantes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RedesSoiciais_EventoId",
                table: "RedesSoiciais",
                column: "EventoId");

            migrationBuilder.CreateIndex(
                name: "IX_RedesSoiciais_PalestranteId",
                table: "RedesSoiciais",
                column: "PalestranteId");
        }
